...
class ApiPopularServiceManager{
                
        func fetchDataFromApiByAlamofire(completion :@escaping ([Result]?,String?)->Void){
       
           let url = URL(string:"https://api.themoviedb.org/3/movie/now_playing?api_key=fd954e63af4112fbcf10c1b2944a5cf2&language=en-US&page=1")
